...
@section('content')
    <div class="container-fluid">
        ...
        <form role="form" method="post" action="{{route('courses.update', $courses->id)}}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" placeholder="{{ __('messages.description') }}" rows="10">{{$courses->description}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
